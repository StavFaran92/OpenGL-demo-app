...
bool PostProcessProjector::init(int windowWidth, int windowHeight)
{
	...
	m_screenShader = ShaderBuilder::buildShaderShared<Shader>("Resources\\Shaders\\PostProcess\\PostProcessShader_default.vert", "Resources\\Shaders\\PostProcess\\PostProcessShader_default.frag");
